...
Including another URLconf
    ...
    2. Add a URL to urlpatterns:  path('blog/', include('blog.urls'))
"""
from main.views import add_inventory_item, inventory_list, stock_movement, stock_list, sensor_build, sensor_detail,generate_pdf, deployed_sensors, update_deployment_status
from main.views_auth import login_view, logout_view, register_view, user_management
